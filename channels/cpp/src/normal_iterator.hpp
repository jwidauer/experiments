...
class NormalIterator {
 ...
 public:
  ...
  explicit constexpr NormalIterator(Iterator&& i) noexcept : current{std::move(i)} {}
...
[[nodiscard]] constexpr auto make_normal_iterator(Iter&& i) noexcept -> NormalIterator<Iter, Container> {
